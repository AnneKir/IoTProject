...
export declare const ReactSimplePeerStatusState: BehaviorSubject<Status>;
export declare const ReactSimplePeerState: BehaviorSubject<IReactSimplePeerState>;
export declare function setModel(model: ReactSimplePeerModel): void;
export declare function setRoom(room: string): void;
