...
const singly_linked_list_1 = require("./singly-linked-list");
describe('new SinglyLinkedList', function () {
    it('should be empty', function () {
        let list = new singly_linked_list_1.SinglyLinkedList();
...
//# sourceMappingURL=singly-linked-list.spec.js.map